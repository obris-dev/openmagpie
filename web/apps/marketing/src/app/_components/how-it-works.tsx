...
export function HowItWorks() {
  return (
    <section id="how" className="relative border-b border-ink/10 dark:border-paper/10">
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.5fr] lg:gap-16">
          <div className="reveal">
            ...
            <h2 className="mt-5 text-3xl font-bold tracking-tight text-balance sm:text-5xl">
              Describe what matters. It watches the rest.
            </h2>
            <p className="mt-5 max-w-sm text-lg leading-relaxed text-ink-muted dark:text-paper/70">
